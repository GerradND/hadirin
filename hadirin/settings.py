"""
Django settings for hadirin project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-@%3(w!)_3yf-xx-nrh(z#b^$7yb0lz%)%g7u0dhb#!gm_2_q@+')
...
WSGI_APPLICATION = 'hadirin.wsgi.application'
